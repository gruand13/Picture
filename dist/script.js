...
var accordion = function accordion(triggersSelector) {
  ...
  }); // c помощью классов и css селекторов
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    } else if (promocodeBlock.value === "IWANTPORT") {
...
var drop = function drop() {
  ...
  //dragstart *
  //drop - обьект отпправлен в dropArea
  ...
  function preventDefaults(e) {
    e.preventDefault(); //остановка всплытия
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight) - 5;
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    ...
    img.src = img.src.slice(0, -4) + '-1.png'; // все кроме класса sizes-hit
  ...
  function hideImg(block) {
    ...
    img.src = img.src.slice(0, -6) + '.png'; // все кроме класса sizes-hit
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // простой вариант когда мы добавляем из верстки стили
  // cards.forEach(card =>{
  ...
  btn.addEventListener('click', function () {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])('assets/db.json') // если рабоатем с сервером то пишем просто res а если с файлом из папки res.styles
    .then(function (res) {
